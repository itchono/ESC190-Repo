...
class BalancingTree:
	...
	def print_tree(self):
		...
		CREDITS: TAKEN FROM RYAN ZHANG ON DISCOURSE POST WITH FULL PERMISSION
		ALL RIGHTS RESERVED TO HIM
		THIS CODE DOES NOT AFFECT FUNCTIONALITY OR FEATURES WHICH COUNT AS A VIOLATION OF ESC190 PROTOCOL
		THIS DOES NOT ENHANCE ANY OF THE METHODS WHICH NEED TO BE IMPLEMENTED

		THUS THIS IS NOT ACADEMIC DISHONESTY
		'''
		queueboi = [self.root]
		output = ""
		while queueboi:
